...
function Navbar() {
  return (
    <div>
      <nav className="bg-black  px-2 sm:px-4 py-2.5 dark:bg-[#4da8da]  ">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-300 dark:focus:ring-gray-600"
