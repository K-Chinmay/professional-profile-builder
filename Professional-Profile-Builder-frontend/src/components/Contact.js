...
function Contact() {
  ...
  return (
    ...
    <Nav/>
      <section className="relative z-10 overflow-hidden bg-[#4da8da] py-20 lg:py-[120px]">
        <div className="container mx-auto">
          <div className="mx-8 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12 ">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-body-color mb-9 text-base leading-relaxed">
                  In case of any query or problem you can contact us at any of
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              ...
              <h1 className="text-xl font-bold mb-4 leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-black">
                Contact us
              </h1>
                <form method="POST">
                  <div className="mb-6">
                    <input
                      ...
                      className="text-body-color border-b-2 border-gray-800 w-full  py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      value={userData.name}
                  ...
                  <div className="mb-6">
                    <textarea
                      ...
                      className="text-body-color border-2 border-gray-800 rounded w-full resize-none   py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-[#4da8da] border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      onClick={ContactForm}
                    >
                      Send Message
                    </button>
